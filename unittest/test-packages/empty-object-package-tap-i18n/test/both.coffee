Tinytest.add 'empty-package-tap-i18n - TAPi18n.packages generated correctly', (test) ->
  test.equal Package["tap:i18n"].TAPi18n.packages, {"tap-tests:empty-object-package-tap-i18n":{"translation_function_name":"__","helper_name":"_","namespace":"tap-tests:empty-object-package-tap-i18n"}}
