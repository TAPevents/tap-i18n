...
class I18nJsonCompiler extends CachingCompiler
  constructor: ->
    super
  ...
  compileOneFile: (inputFile) ->
    ...
    if helpers.isPackage(inputFile)
      if "web" in inputFile.getArch() and helpers.getCompileStepArchAndPackage(inputFile) not in compiler_configuration.templates_registered_for
        output +=
          """
